...
This guide will show you how to use fluid-tailwind on WordPress websites using Yabe Siul.
...
Import the `fluid-tailwind` package and add it to the `presetConfig.plugins` array.
...
![preset.js file](../../../../assets/images/guides/recipes/fluid-tailwind/0.png)

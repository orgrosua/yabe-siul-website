...
To enable the hover preview feature, you need to install the [**Yabe Bricksbender**](#bricksbender) plugin.
...
To sort the class names, you need to install the [**Yabe Bricksbender**](#bricksbender) plugin.

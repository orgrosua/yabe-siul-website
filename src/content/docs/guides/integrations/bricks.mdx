...
:::note
Requires [**Bricksbender**](#bricksbender) plugin.
:::
...
To enable the feature, you can go to `Yabe Siul → Settings` and open the `General` panel. Then, tick the `Enable engine integration` checkbox.
